...
stashes a :class:`~agenttic.gaming.schema.GamingProbeResult` (as a dict) on the
...
from agenttic.gaming.schema import GamingProbeResult
from agenttic.schema.scorecard import RunScore, Scorecard
from agenttic.schema.testcase import TestCase
from agenttic.schema.trace import Trace
from agenttic.scoring.checks import CheckConfigError, check
...
def gaming_run_scores(report) -> list[RunScore]:
    ...
    from agenttic.gaming.rubric import GAMING_UNCALIBRATED, SUB_RUBRICS
...
def gaming_scorecard(report) -> Scorecard:
    ...
    from agenttic.gaming.rubric import GAMING_RUBRIC
