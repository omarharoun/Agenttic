...
JS_RUNNER = Path("src/agenttic/verifier/js/verify_golden.js")
...
def test_relying_party_accepts_valid_rejects_revoked():
    from agenttic.verifier.header import HEADER_NAME, encode_passport_header
