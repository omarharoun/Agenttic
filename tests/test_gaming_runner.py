...
from agenttic.gaming.probes import (
    BEHAVIOR_DELTA_PROBES,
    CONSISTENCY_PROBES,
    HELDOUT_PROBES,
    SANDBAGGING_PROBES,
)
from agenttic.gaming.runner import detect_eval_awareness, run_gaming
from agenttic.gaming.schema import ProbePair
...
class TestFullSeedRun:
    def test_end_to_end_report_shape(self):
        from agenttic.gaming.probes import SEED_PROBES
