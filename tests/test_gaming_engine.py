...
from agenttic.gaming.checks import gaming_run_scores, gaming_scorecard
from agenttic.gaming.rubric import GAMING_RUBRIC, GAMING_UNCALIBRATED, SUB_RUBRICS
from agenttic.gaming.schema import GamingProbeResult, GamingReport
...
class TestProvisionalScorecard:
    ...
    def test_wrong_mechanism_wiring_is_a_config_error(self):
        from agenttic.gaming.checks import not_sandbagging
